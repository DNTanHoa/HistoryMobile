...
using HistoryMobile.Backend.Blazor.Server.Services;

namespace HistoryMobile.Backend.Blazor.Server {
    public partial class BackendBlazorApplication : BlazorApplication {
        public BackendBlazorApplication() {
            InitializeComponent();
        }
        ...
        private void BackendBlazorApplication_DatabaseVersionMismatch(object sender, DatabaseVersionMismatchEventArgs e) {
#if EASYTEST
            e.Updater.Update();
            e.Handled = true;
#else
