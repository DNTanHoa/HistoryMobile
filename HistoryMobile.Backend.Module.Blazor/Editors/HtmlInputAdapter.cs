...
{
    public class HtmlInputAdapter : ComponentAdapterBase
    {
        public HtmlInputAdapter(HtmlInputModel componentModel)
        {
            ComponentModel = componentModel ?? throw new ArgumentNullException(nameof(componentModel));
            ComponentModel.ValueChanged += ComponentModel_ValueChanged;
        }
        public HtmlInputModel ComponentModel { get; }
        ...
        {
            return ComponentModelObserver.Create(ComponentModel, HtmlEditor.Create(ComponentModel));
        }
